...
%
\\\inputlisting{../examples_raw/dataflow/dataflow_include-snippet.h}
%
...
%
\\\inputlisting{../examples_raw/dataflow/dataflow_network-snippet.h}
%
...
%
\\\inputlisting{../examples_raw/dataflow/dataflow_source_function-snippet.h}
%
like this:
%
\\\inputlisting{../examples_raw/dataflow/dataflow_declare_source-snippet.h}
%
...
%
\\\inputlisting{../examples_raw/dataflow/dataflow_replace_function-snippet.h}
%
like this:
%
\\\inputlisting{../examples_raw/dataflow/dataflow_declare_replace-snippet.h}
%
...
%
\\\inputlisting{../examples_raw/dataflow/dataflow_sink_function-snippet.h}
%
is used to construct the sink:
%
\\\inputlisting{../examples_raw/dataflow/dataflow_declare_sink-snippet.h}
%
...
%
\\\inputlisting{../examples_raw/dataflow/dataflow_add-snippet.h}
%

As the last step, we have to connect the processes (ports). This is straightforward using the C++ stream operator:
%
\\\inputlisting{../examples_raw/dataflow/dataflow_connect-snippet.h}
%
Once all connections have been established, we can start the network:
%
\\\inputlisting{../examples_raw/dataflow/dataflow_run-snippet.h}
%
...
%
\\\inputlisting{../examples_raw/dataflow/dataflow_producer-snippet.h}
%
...
%
\\\inputlisting{../examples_raw/dataflow/dataflow_declare_add_sources-snippet.h}
%
...
%
\\\inputlisting{../examples_raw/dataflow/dataflow_comparator-snippet.h}
%
...
%
\\\inputlisting{../examples_raw/dataflow/dataflow_consumer-snippet.h}
%
